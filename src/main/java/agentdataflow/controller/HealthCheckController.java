...
public class HealthCheckController {
    ...
    @RequestMapping(value = "/api/health-check", method = RequestMethod.GET, produces = { "application/json"})
    ...
    public ResponseEntity<String> HealthCheck() {
        return new ResponseEntity<>("I'm alive - Api AGENT DATA FLOW!", HttpStatus.OK);
    }
